...
for c_id in 1:n_coms
    ...
    # Plot results.
    scatter!(ax1, ry, sensitivity_sp; label = "simulation")
    lines!(ax1, ry_val, 1 ./ ry_val; color = :black, label = "analytical\nprediction")
    ax1.yreversed = true
    scatter!(ax2, ry, sensitivity_com; label = "simulation")
    lines!(ax2, ry_val, pred_stab; color = :black, label = "analytical\nprediction")
    ax2.yreversed = true
    # axislegend(; position = :rt)
end
fig

save("figures/si-press-coms.png", fig)
#
